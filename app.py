        ...
        if gemini_required:
            ...
            try:
                ...
                prompt_question = (
                    ...
                    "당신은 저축은행 예금상품 전략 담당자이며 "

                    "경영진 대상 금융상품 전략 보고서를 작성하는 전문가입니다.\n\n"



                    "제공된 실제 금리 데이터만 활용하여 "

                    "현재 시장 상황을 분석하고 우리금융저축은행 대응 전략을 제시하세요.\n\n"
                    ...
                    "- 반드시 1~2줄 이내 핵심 전략으로 제시\n"

                    "- 최고금리 무조건 추격 전략 금지\n"

                    "- 시장 평균금리와 상위 경쟁 구간을 고려한 현실적인 전략 제시\n"
                    ...
                    "  · 전략 운영 금리는 시장 상황에 맞게 4.2~4.3% 수준을 우선 검토\n\n"
                    ...
                    "- 단순 금리 인상 외 고객 확보 방법 제시\n"

                    "- 디지털 채널 활용 전략\n"

                    "- 신규 고객 및 재예치 고객 전략 작성\n\n"





                    "4. 데이터 기반 우리금융저축은행 대응 방향\n"

                    "- 우리금융의 시장 위치를 고려하여 작성\n"
                    ...
                    "- 제공 데이터에 없는 시장 사실 생성 금지\n"

                    "- 최고금리(4.45%)만 보고 출혈 경쟁 제안 금지\n"

                    "- 금융회사 경영진 보고서 수준의 문체 유지\n"

                    "- 전략 → 근거 → 실행방향 순서 유지\n"

                    "- 우리금융 데이터와 시장 데이터를 연결하여 설명\n\n"
